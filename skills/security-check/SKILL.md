...
name: security-check
description: >-
  Backend security auditor for authentication, authorization, token handling,
  payment abuse, file uploads, data leaks, injection, and broken access control.
  Inspects every layer of the stack and adapts to Express, NestJS, Django, Rails,
  Go, and other backends. Use when asked to security review, audit, harden, or
  check backend code for vulnerabilities.
---

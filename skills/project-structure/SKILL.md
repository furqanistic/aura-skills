...
description: >-
  Expert backend architecture and project structure for scalable, secure,
  maintainable applications. Inspects the existing stack before writing code,
  prefers feature-based modules, and adapts to Express, NestJS, Fastify, Django,
  Rails, Go, and other backends. Use when designing backend structure,
  reviewing architecture, refactoring modules, or building production-grade
  backend features.
---
